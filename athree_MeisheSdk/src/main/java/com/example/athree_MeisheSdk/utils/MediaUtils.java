...
import com.example.athree_MeisheSdk.MSHookProxy;
import com.example.athree_MeisheSdk.MediaData;
...
public class MediaUtils {
    ...
    private static void getUriColumns(Uri uri) {
        Cursor cursor = MSHookProxy.getmContext().getContentResolver().query(uri, null, null, null, null);
        cursor.moveToFirst();
