            ...
            public boolean onTouch(View p0, MotionEvent it) {
                switch (it.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        beginWidth = VarManger.getDefWidthHeight(context,dialogType)[0];
                        beginHeight = VarManger.getDefWidthHeight(context,dialogType)[1];
...
//                        VarManger.beyondLandSpaceViewLpw = lpW;
                        ...
                        PreferencesUtils.setInt(dialogType==0?"dialogW":"dialogWN", beginWidth);
                        PreferencesUtils.setInt(dialogType==0?"dialogH":"dialogHN",beginHeight);
                        break;
                }
                return true;
            }
...
//                }
                viewEvent.changeScreenOri(true,false);
            }
        });
