...
public class VarManger {
    ...
    public static boolean fristStartTc = false;
...
//    }
    ...
    public static Integer[] getDefWidthHeight(Context context,int dialogType){
        DisplayMetrics displayMetrics = context.getResources().getDisplayMetrics();
        return new Integer[]{PreferencesUtils.getInt(dialogType==0?"dialogW":"dialogWN",(int) (displayMetrics.widthPixels * 0.8)),
                PreferencesUtils.getInt(dialogType==0?"dialogH":"dialogHN",(int) (displayMetrics.heightPixels * 0.4))};
    }
...
//    }
    ...
    public static Integer[] getDefWidthHeightLandSpace(Context context,int dialogType){
        DisplayMetrics displayMetrics = context.getResources().getDisplayMetrics();
        return new Integer[]{PreferencesUtils.getInt(dialogType==0?"dialogLsW":"dialogLsWN",(int) (displayMetrics.widthPixels * 0.8)),
                PreferencesUtils.getInt(dialogType==0?"dialogLsH":"dialogLsHN",(int) (displayMetrics.heightPixels * 0.4))};
    }
...
//    }
    ...
    public static Integer[] getDefXY(Context context,int dialogType){
        return new Integer[]{PreferencesUtils.getInt(dialogType==0?"dialogX":"dialogXN",0),PreferencesUtils.getInt(dialogType==0?"dialogY":"dialogYN",VarManger.getSystemBarHeight(context))};
    }
