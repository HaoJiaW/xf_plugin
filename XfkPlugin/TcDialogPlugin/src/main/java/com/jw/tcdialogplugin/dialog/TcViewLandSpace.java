...
import com.jw.xfkplugin.AutoScrollTextView;
import com.jw.xfkplugin.PreferencesUtils;
import com.jw.xfkplugin.R;
import com.jw.xfkplugin.SettingService;
            ...
            public boolean onTouch(View p0, MotionEvent it) {
                switch (it.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        beginWidth = VarManger.getDefWidthHeightLandSpace(context)[0];
                        beginHeight = VarManger.getDefWidthHeightLandSpace(context)[1];
...
//                        VarManger.beyondLandSpaceViewLpw = lpW;
                        ...
                        PreferencesUtils.setInt("dialogLsW", beginWidth);
                        PreferencesUtils.setInt("dialogLsH",beginHeight);
                        break;
                }
                return true;
            }
